...
## Conclusion
Les ~60 % annoncés sont **réels et robustes dans le temps**. La marge de progression connue est la classe « nul », qui demande des signaux externes (cotes, compositions, enjeu du match).
